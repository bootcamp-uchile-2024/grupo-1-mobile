...
import com.example.plantopiapp.dataclases.Maceteros
import java.text.NumberFormat
import java.util.Locale

class MaceterosAdapter : RecyclerView.Adapter<MaceterosAdapter.ProductViewHolder>() {
        private val productList = mutableListOf<Maceteros>()
        ...
        fun setProducts(newProducts: List<Maceteros>) {
            productList.clear()

...
class RecuperaPass_3rd : Fragment(R.layout.fragment_recupera_pass_3rd) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val button = view.findViewById<Button>(R.id.button_recover3rd)
        button.setOnClickListener {
            val next_fragment = RecuperaPass_4th()

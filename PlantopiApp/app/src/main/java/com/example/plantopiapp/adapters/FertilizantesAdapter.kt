...
import com.example.plantopiapp.dataclases.Fertilizante
import java.text.NumberFormat
import java.util.Locale

class FertilizantesAdapter : RecyclerView.Adapter<FertilizantesAdapter.ProductViewHolder>() {
        private val productList = mutableListOf<Fertilizante>()
        ...
        fun setProducts(newProducts: List<Fertilizante>) {
            productList.clear()
